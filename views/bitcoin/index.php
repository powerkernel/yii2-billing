            ...
            <div class="table-responsive">
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        //'id',
                        ['attribute' => 'address', 'value' => function ($model){return Html::a($model->address, Yii::$app->urlManager->createUrl(['/billing/bitcoin/view', 'id'=>(string)$model->id]), ['title'=>Yii::$app->getModule('billing')->t('View BTC Address'), 'data-pjax'=>0]) ;}, 'format'=>'raw'],
                        'id_invoice',
                        //'id_account',
