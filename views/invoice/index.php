            ...
            <div class="table-responsive">
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        ['attribute' => 'total', 'value' => function ($model){return Yii::$app->formatter->asCurrency($model->total, $model->currency);}],
                        // 'currency',
                        // 'status',
                        // 'created_at',
                        // 'updated_at',
                        ...
                        ['attribute' => 'status', 'value' => function ($model){return $model->getStatusColorText();}, 'filter'=> Invoice::getStatusOption(), 'format'=>'raw'],
