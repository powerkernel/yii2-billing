...
class Invoice extends ActiveRecord
{
    ...
    public function getInvoiceUrl($absolute = false)
    {
        ...
        if (Yii::$app->id != 'app-frontend') {
            return Yii::$app->urlManagerFrontend->createAbsoluteUrl(['/billing/invoice/show', 'id' => $this->id]);
        }
        return Yii::$app->urlManager->$act(['/billing/invoice/show', 'id' => $this->id]);
    }
    ...
    /**
     * sending new invoice email to admin
     * @return bool
     */
